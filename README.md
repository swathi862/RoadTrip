...
+ By clicking on the **_Save to 'My Trips'_** button on the 'Details' modal, you can add this trip to your **My Trips** page, specifically under the 'Future Trips' tab.
